          ...
          {[
            {
              ...
              desc: 'Our AI maps exactly how you think — not just what you get wrong, but why. Then it fixes that specific pattern.'
            },
            {
              icon: '🎯',
              title: 'Surgical Practice',
              desc: 'No more random questions. Every question you see is chosen specifically for your weak spots on that day.'
            },
            {
              icon: '📊',
              title: 'Real Insights',
              desc: 'Not just "you scored 65%". We tell you exactly which patterns cost you marks and how to fix them.'
            },
            {
              icon: '⏱️',
              title: '20 Min Daily',
              desc: 'Designed for real life. 20 focused minutes with ExamNinja beats 3 hours of random practice.'
            },
            {
              icon: '🏆',
              title: 'Score Prediction',
              desc: 'Know your likely CLAT score right now — and exactly what to do to increase it.'
            },
            {
              icon: '🌍',
              title: 'Hindi + English',
              desc: 'Full platform in Hindi and English. Because your language should never be a barrier.'
            }
          ].map((feature, i) => (
            <div key={i} style={{
