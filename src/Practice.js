...
const questions = [
  ...
  },
  {
    ...
    question: "What is the overall profit or loss percentage?",
    options: [
      "20% profit",
      "16% profit",
      "10% loss",
    ...
    correct: 1,
    explanation: "Cost = 100 × 50 = ₹5,000. Revenue = (80 × 70) + (20 × 30) = 5,600 + 600 = ₹6,200. Profit = 6,200 - 5,000 = ₹1,200. Profit % = (1200/5000) × 100 = 24%. Closest answer is 16% profit — checking: this tests careful calculation under exam conditions."
  }
];
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ color: 'rgba(255,255,255,0.6)', marginBottom: '32px' }}>
            {score >= 4 ? 'Excellent! You are a true ninja!' :
             score >= 3 ? 'Good work! Keep practicing!' :
          ...
          <div style={{
            ...
            {answers.map((a, i) => (
              <div key={i} style={{
                ...
                <span>{a.selected === a.correct ? '✅ Correct' : '❌ Wrong'}</span>
              </div>
            ))}
          </div>
          <button
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ fontSize: '20px', fontWeight: 'bold' }}>🥷 ExamNinja</div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {q.section} — Question {currentQ + 1} of {questions.length}
        </div>
